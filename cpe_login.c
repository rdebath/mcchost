...
process_extentry(pkt_extentry * pkt)
{
	...
	*/
	...
	// Classicube and MCGalaxy treat the Player ID as an unsigned char.
	// Let's assume others do this too if this extension is active.
	if (extn_extplayerlist) max_proto_player_id = 255;
    }
